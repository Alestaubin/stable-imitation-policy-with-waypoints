...
python sim/playback_robomimic_dataset.py --dataset "$DATA_PATH/$OUTPUT_NAME" --video_path "$DATA_PATH/demo.mp4" 
printf "Playback video saved to $DATA_PATH/demo.mp4\n"

########## AWE waypoints ##########
# convert delta actions to absolute actions
python lib/utils/robomimic_convert_action.py --dataset "$DATA_PATH/$OUTPUT_NAME" --start_idx 0 --end_idx 49
